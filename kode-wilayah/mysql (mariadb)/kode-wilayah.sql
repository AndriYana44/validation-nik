...
--
-- Host: localhost
-- Generation Time: Dec 02, 2021 at 01:04 PM
...
CREATE TABLE `districts` (
  ...
  `id_regency` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `name` varchar(28) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL
...
INSERT INTO `districts` (`code`, `id_regency`, `name`) VALUES
